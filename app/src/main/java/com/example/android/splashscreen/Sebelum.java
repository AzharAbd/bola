...
public class Sebelum extends Fragment {
    ...
    MyAdapter myAdapter;
    private static final String TAG = "Sebelum";
...
//        Log.d(TAG, team_id_check);
        View view = inflater.inflate(R.layout.fragment_sebelum, container, false);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.rv_sebelum);
    ...
    private void parseJSONMatch() {
        String urlEvent = "https://www.thesportsdb.com/api/v1/json/1/eventslast.php?id=133601";
                ...
                new Response.Listener<JSONObject>(){
                    ...
                    public void onResponse(JSONObject response){
                        try {
                            ...
                            myAdapter = new MyAdapter(getContext(), mModels);
